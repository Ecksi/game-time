...
class Hero {
  ...
  onABurger() {
    var currentBurger = 
    this.burgerLayer.burgerLayers.filter(
      i => {
        this.x >= i.x &&
        this.x + 40 <= i.x + i.w &&
        i.y + 10 === this.y + 55
