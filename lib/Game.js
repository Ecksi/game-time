...
class Game {
  ...
  keyboardConditions(currentPlatform) {
    currentPlatform = currentPlatform[0];
      ...
      if (this.hero.onLadder === true && currentPlatform && currentPlatform.l === 8) { 
          this.keyboarder.keyState.up = 'enabled';
      ...
      if (this.hero.onLadder === true && currentPlatform && currentPlatform.l === 1) { 
      ...
      if (this.hero.onPlatform === true && currentPlatform && this.hero.x === currentPlatform.x) {
        this.keyboarder.keyState.left = 'disabled';
      }

      if (this.hero.onPlatform === true && currentPlatform && this.hero.x + 40 === currentPlatform.x + currentPlatform.w) {
        this.keyboarder.keyState.right = 'disabled';
      }
  }
  ...
  burgerCollision() {
    ...
    var currentPlatform = this.platformCollision();
  ...
  createBurgers() {
    var burgerLayersLevel1 = this.level1[0]['burgers'];

    return burgerLayersLevel1;
  }

  createLadders() {
    var laddersLevel1 = this.level1[1]['ladders'];

    return laddersLevel1;
  }

  createPlatforms() {
    var platformsLevel1 = this.level1[2]['platforms'];

    return platformsLevel1;
  }

  createPlates() {
    var platesLevel1 = this.level1[3]['plates'];
